...
# Senza versione nel nome: così il link "releases/latest/download/Underdock.dmg"
# resta buono a ogni rilascio. La versione sta nel tag.
DMG="$ROOT/build/Underdock.dmg"
VOLUME="Underdock"
STAGE="$(mktemp -d)"
...
echo
echo "Fatto: $DMG ($SIZE) — versione $VERSION"
